...
Coaches are expensive to hire. Apps provide users with some basic stats about their runs, but users typically have to purchase a subscription to get useful insights into training. These insights aren't catered to individual users. Programming languages give individuals an opportunity to gain deep insights into their own training. Further, research that is conducted regarding athletic performance tends to focus on the aggregate of many participants, like in "Human running performance from real-world big data" by Thorsten Emig & Jussi Peltonen. Papers like this are useful in creating a general model to understand performance, but do not investigate methods and objectives that can help us understand the performance of individuals. 
